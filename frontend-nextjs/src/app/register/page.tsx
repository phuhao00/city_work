...
export default function RegisterPage() {
  ...
  const validateForm = () => {
    ...
    else if (formData.password !== formData.confirmPassword) newErrors.confirmPassword = '两次密码不一致';
          ...
          <div className="space-y-4">
            <div>
              ...
              <div className="relative">
                <User className="absolute left-3 top-1/2 transform -translate-y-1/2 text-gray h-5 w-5" />
                <input
                  id="name"
                  name="name"
                  type="text"
